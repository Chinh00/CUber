...
namespace IdentityService.Api.Pages.Admin.ApiScopes;
...
public class EditModel : PageModel
{
    ...
    [BindProperty] public ApiScopeModel InputModel { get; set; } = default!;
    [BindProperty] public string Button { get; set; } = default!;
