...
namespace Services
{
	...
	{
		public static global::Avro.Schema _SCHEMA = global::Avro.Schema.Parse("{\"type\":\"record\",\"name\":\"CustomerCreatedIntegrationEvent\",\"namespace\":\"Services\"," +
				"\"fields\":[{\"name\":\"Id\",\"type\":\"string\"},{\"name\":\"FullName\",\"type\":\"string\"},{\"na" +
				"me\":\"PhoneNumber\",\"type\":\"string\"}]}");
		private string _Id;
